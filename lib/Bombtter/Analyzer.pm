...
#	my $seps = '。|．|\.\s|、|，|,\s|！|!|？|\?|…|･･|・|：|ｗ+|（|）|「|『|」|』|\s';
	...
	my $sadds = $cadds . "|うあー|あー|もう|あーもう|ちくしょー|思うと|つーことで|なんだ(?!かんだ|か)(?:ってー)?|やっぱり|くっ?そ(?:ー|ぅ|ぉ)?|そして|言う(?:が|けど)|(?:という|てな)わけで|どういうことだ(?!か)|速やかに|あるいは|もしくは|または|[$seps]のに|つまり|あれだ|ええい(?!ああ)|(?:何|なに)が|・{2,}|＼|ぐお{2,}|(?:まと|纏)めると";
