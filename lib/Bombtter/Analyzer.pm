...
#	my $seps = '。|．|\.\s|、|，|,\s|！|!|？|\?|…|･･|・|：|ｗ+|（|）|「|『|」|』|\s';
	...
	my $cadds = 'とりあえず|取り[敢合あ]えず|(?:ほんと|ホント|本当)に?|(?:マジ(?!アカ|ック|コン)|まじ)で?|だったら|ついでに|＞＜|末[永長]く|w{3,}|～{2,}';
	my $sadds = $cadds . "|うあー|あー|もう|あーもう|ち[くき]しょー|思うと|つーことで|なんだ(?!かんだ|か)(?:ってー)?|やっぱり|くっ?そ(?:ー|ぅ|ぉ)?|そして|言う(?:が|けど)|(?:という|てな)わけで|どういうことだ(?!か)|速やかに|あるいは|もしくは|または|[$seps]のに|つまり|あれだ|ええい(?!ああ)|(?:何|なに)が|・{2,}|[＼／【】…]|ぐお{2,}|(?:まと|纏)めると|[あー]{3,}";
