...
#	my $seps = '。|．|\.\s|、|，|,\s|！|!|？|\?|…|･･|・|：|ｗ+|（|）|「|『|」|』|\s';
	...
	my $cadds = 'とりあえず|取り[敢合あ]えず|(?:ほんと|ホント|本当)に?|(?:マジ(?!アカ|ック)|まじ)で?|だったら|ついでに';
	my $sadds = $cadds . "|うあー|あー|もう|あーもう|ちくしょー|思うと|つーことで|なんだ(?!かんだ)(?:ってー)?|やっぱり|くっ?そ(?:ー|ぅ|ぉ)|そして|言う(?:が|けど)|(?:という|てな)わけで|どういうことだ(?!か)|速やかに|あるいは|もしくは|または|[$seps]のに|つまり|あれだ|ええい(?!ああ)|(?:何|なに)が|・{2,}";
	my $eadds = $cadds . '|ごと|みんな|皆|なんて|なんか|とか|がって|いったん|一旦|本気で|今すぐ|まとめて';
