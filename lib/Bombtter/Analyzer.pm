...
#	my $seps = '。|．|\.\s|、|，|,\s|！|!|？|\?|…|･･|・|：|ｗ+|（|）|「|『|」|』|\s';
	...
	my $sadds = $cadds . "|うあー|あー|もう|あーもう|ちくしょー|思うと|つーことで|なんだ(?!かんだ|か)(?:ってー)?|やっぱり|くっ?そ(?:ー|ぅ|ぉ)?|そして|言う(?:が|けど)|(?:という|てな)わけで|どういうことだ(?!か)|速やかに|あるいは|もしくは|または|[$seps]のに|つまり|あれだ|ええい(?!ああ)|(?:何|なに)が|・{2,}|＼|ぐお{2,}|(?:まと|纏)めると|あ{3,}";
	my $eadds = $cadds . '|ごと|みんな|皆|なんて|なんか|とか|がって|いったん|一旦|本気で|(?:今|いま)すぐ|(?:まと|纏)めて|(?:(?:\d+|[１２３４５６７８９０一二三四五六七八九]+)?[十百千万億兆]?)+回';
